...
public class Match3Product extends AndroidProduct {
    ...
    {
        Intent intent = new Intent( this, m3BoardActivity.class );
...
//	public Match3Product() {
//		super();
//		services = new AndroidServices(this, "Match3");
		//
//				// Regular Brickles
